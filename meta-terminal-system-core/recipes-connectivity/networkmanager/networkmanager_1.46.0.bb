...
# The networkmanager 1.46.0 main recipe cannot be built as is on kirkstone.
# To build on kirkstone, the following definitions need to be added.
# TODO: Remove this if updated to scarthgap.
