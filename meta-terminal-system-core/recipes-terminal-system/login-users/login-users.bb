...
do_install:append:mender-image() {
    ...
    # Also create /home/root directories
    install -d -m 0700 ${D}/data/overlay/home/root
    install -d -m 0700 ${D}/data/overlay/work/home/root
}
