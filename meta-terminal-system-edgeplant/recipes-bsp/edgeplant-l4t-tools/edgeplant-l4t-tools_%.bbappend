...
SRC_URI += " \
    file://0001-feat-exclusive-access-to-powermanage.patch \
    file://reboot.target \
"
PV = "${TS_EDGEPLANT_L4T_TOOLS_VERSION}"
FILES:${PN} += "${sysconfdir}/systemd/system/reboot.target"
...
do_install:append () {
    ...
    # PD-1979: override reboot.target to convert reboot to poweroff
    install -d ${D}${sysconfdir}/systemd/system
    install -m 0644 ${WORKDIR}/reboot.target ${D}${sysconfdir}/systemd/system/reboot.target
}
